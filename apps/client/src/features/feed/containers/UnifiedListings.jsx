    ...
    <>
      ...
      <header className="feed-top-nav" style={{ paddingBottom: '1rem' }}>
        <div>
          ...
          <h1 className="feed-header-title" style={{ fontSize: '2rem' }}>Mis Autos</h1>
        </div>
        <button 
      ...
      <main className="feed-main-area" style={{ alignItems: 'stretch', marginTop: 0, overflowY: 'auto', padding: '0 1rem' }}>
        ...
        <div className="seller-listings-list">
          {isLoading ? (
            ...
            <div className="seller-empty-state">
              ...
              <button className="btn-primary" style={{ maxWidth: '250px' }} onClick={() => navigate('/seller/listings/new')}>
              ...
              <div key={listing.id} className="seller-listing-card">
                ...
                <div className="seller-listing-info">
                  <div className="seller-listing-header">
                    <h3 className="seller-listing-title">{listing.brand} {listing.model}</h3>
